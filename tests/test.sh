...
declare -a SCENARIOS=(
  ...
  "same-host-overlap-path-1       app.example.com   /          app.example.com   /a     deny    cross"
  "same-host-overlap-path-1s      app.example.com   /          app.example.com   /a/    deny    cross"
  "same-host-overlap-path-2       app.example.com   /          app.example.com   /a/b   deny    cross"
  "same-host-overlap-path-2s      app.example.com   /          app.example.com   /a/b/  deny    cross"
  "same-host-overlap-path-3       app.example.com   /a         app.example.com   /a/b   deny    cross"
  "same-host-overlap-path-3s      app.example.com   /a         app.example.com   /a/b/  deny    cross"
  "same-host-overlap-path-1r      app.example.com   /a         app.example.com   /      deny    cross"
  "same-host-overlap-path-1sr     app.example.com   /a/        app.example.com   /      deny    cross"
  "same-host-overlap-path-2r      app.example.com   /a/b       app.example.com   /      deny    cross"
  "same-host-overlap-path-2sr     app.example.com   /a/b/      app.example.com   /      deny    cross"
  "same-host-overlap-path-3r      app.example.com   /a/b       app.example.com   /a     deny    cross"
  "same-host-overlap-path-3sr     app.example.com   /a/b/      app.example.com   /a     deny    cross"
  ...
  "same-host-overlap-path-1       app.example.com   /          app.example.com   /a     allow   same"
  "same-host-overlap-path-1s      app.example.com   /          app.example.com   /a/    allow   same"
  "same-host-overlap-path-2       app.example.com   /          app.example.com   /a/b   allow   same"
  "same-host-overlap-path-2s      app.example.com   /          app.example.com   /a/b/  allow   same"
  "same-host-overlap-path-3       app.example.com   /a         app.example.com   /a/b   allow   same"
  "same-host-overlap-path-3s      app.example.com   /a         app.example.com   /a/b/  allow   same"
  "same-host-overlap-path-1r      app.example.com   /a         app.example.com   /      allow   same"
  "same-host-overlap-path-1sr     app.example.com   /a/        app.example.com   /      allow   same"
  "same-host-overlap-path-2r      app.example.com   /a/b       app.example.com   /      allow   same"
  "same-host-overlap-path-2sr     app.example.com   /a/b/      app.example.com   /      allow   same"
  "same-host-overlap-path-3r      app.example.com   /a/b       app.example.com   /a     allow   same"
  "same-host-overlap-path-3sr     app.example.com   /a/b/      app.example.com   /a     allow   same"
